...
class TrelloFacadeTest {
    ...
    void shouldCreateCard() {
        ...
        // Mock trelloMapper.mapToCard()
        when(trelloMapper.mapToCard(trelloCardDto)).thenReturn(trelloCard);
        when(trelloMapper.mapToCardDto(trelloCard)).thenReturn(trelloCardDto);

        // Mock trelloService.createTrelloCard()
        CreatedTrelloCardDto expectedDto = new CreatedTrelloCardDto("CardId", "CardName", "CardShortUrl");
        when(trelloService.createTrelloCard(trelloCardDto)).thenReturn(expectedDto);
        ...
        verify(trelloService, times(1)).createTrelloCard(any(TrelloCardDto.class));
